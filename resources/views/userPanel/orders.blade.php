...
<div class="col-md-8">
    <div class="row mt-5 pt-5 pl-5">
        <div class="col-md-10">
            ...
            <h1 class="dashbaord-heading pt-2">My Orders</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3 col-md-3 card-borders m-2">
                <div class="row p-5">
                    <div class="col-sm-8">
                        <div class="row">
            ...
            <div class="col-sm-4 col-md-4 card-borders m-2">
                <div class="row p-5">
                    <div class="col-sm-8">
                        <div class="row">
                            <img src="/images/cancelled.png" alt="logo" width = "auto" height = "auto">
                        </div>
                        <div class="row pt-2 active-orders">
                    ...
                    <div class="col-sm-3 pt-3 active-orders-numbers">
                        <h1>{{ str_pad($canceledOrdersCount, 2, '0', STR_PAD_LEFT) }}</h1>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($status === 'active' || $status === 'Active' ) {
                                ...
                                $dotColor = 'blue';
                            } elseif ($status === 'canceled' || $status === 'Canceled') {
                                $dotColor = 'red';
                            }

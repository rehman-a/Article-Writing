        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="{{ route('placeorder') }}" class="nav_link  mb-0" >
                        <i class='bx bx-grid-alt nav_icon'></i>
                    ...
                    <a href="{{ route('settings') }}" class="nav_link  mb-0">
                        <i class='bx bx-grid-alt nav_icon'></i>
            ...
            <form method="POST" action="{{ route('logout') }}" id="logout-form">
                    ...
                    <button class="row pb-5 mt-5 dashboard-category height" type="submit">
                        <div class="col-sm-4 col-md-4 text-right"><img src="/images/Sign out.png" alt="logo" width="auto" height="auto"></div><div class="col-sm-8 col-md-8 dashboard-text pt-1"><h5>Logout</h5></div>
                    </button>
             </form>

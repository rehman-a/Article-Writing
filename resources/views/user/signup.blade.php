    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12 pt-3 mt-3">
                        <span class="order-form">Passowrd</span>
                        <div class="pt-2">
                            <input type="password" class="input-field-order" >
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 pt-3 mt-3 mb-5 ">
                        <span class="order-form">Confirn Passowrd</span>
                        <div class="pt-2">
                            <input type="password" class="input-field-order" >
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button class="navbtn p-2 pl-3 pr-3 bl-3 br-3 text-end"><span class="pr-1">Signup </span>  <img src="/images/arrow_right_alt.png" width="10" height="10"></button>
